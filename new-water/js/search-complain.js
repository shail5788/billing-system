$(document).ready(function(){
       ...
       $("#customer_id").keyup(function(){
             ...
             var customer_id=$(this).val();
              ...
              if(customer_id!='')
              {
                     ...
                     var action="seachCompalinByCustomerId";

                     var html="";
                     var status="";
                     html+="<table class='table table-borderd table-hover' style='background:white;'>"+
                     "<tr><th>complain_id</th><th>Customer Id</th>"+
       ...
       $("#complain_id").keyup(function(){
             ...
             if(complain_id!='')
             {
                 ...
                 var action="searchCompalinByComplainId";
      ...
      $('#year').change(function(){
          ...
          var year=$('#year').val();
              ...
              $('#month').change(function(){
                  ...
                  var month=$('#month').val();
                    ...
                    var action ="searchComplaintMonthly";
       ...
       $("#date1").blur(function(){
              ...
              var action ="searchComplainByDatewise";
