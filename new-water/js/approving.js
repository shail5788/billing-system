                   ...
                   $.post("ajax.php",{customer_id:customer_id,action:action},function(data){
                      ...
                      for(var i=0;i<data.length;i++)
                      {
                         j++;
                          ...
                          "</td><td data-toggle='collapse' data-target='#demo''"+j+"' class='seen'><a href='#' id='seeData'  Ide='"+data[i].customer_id+"'>See</a>|"+
                          "<a href='#' class='approve' id='approve1' Ide='"+data[i].customer_id+"'>Approve</a></td>"+
                      ...
                      $('.seen #seeData').click(function(){
                         ...
                         $.post('approving.php',{id:id,action:action},function(data){
