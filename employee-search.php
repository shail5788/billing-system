...
<?php include "include/header.php"; ?>
 ...
 <?php
  ...
  <div class="content-wrapper">
    ...
    <script type="text/javascript" src="js/employee_searching.js"></script> 
                      ...
                      <div class="modal-body">
                        <div class="row data_content">
                          <div class="col-md-12  detail table-responsive"
                           style="margin:auto;" id="detail">
                         </div>
                     </div>
                    <div class="modal-footer">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                           <button type="button" class="btn btn-primary " id="printEmpDetail" onclick="printReport('detail')">Print </button>
                </div>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
