...
?> 
 ...
 ?>
     ...
     <!-- <div class="row">-->
       ...
       <script type="text/javascript" src="js/search-complain.js"></script>
       ...
       <div class="row">
        ...
        <div class="col-md-2">
          ...
          <div class="col-md-1">
             <button class="btn btn-block btn-default" onclick="printCompReport('printArea')"> Print <span class="glyphicon glyphicon-print"></span></button>
          </div>
