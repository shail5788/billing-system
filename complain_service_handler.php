...
<?php include "include/header.php"; ?>
 ...
 <?php include("navbar/complainheader.php");?>
  ...
  <div class="col-md-2">Location</div><div class="col-md-2">City</div><div class="col-md-1">Date</div><div class="col-md-1">
    ...
    Feedback</div>
     ...
     <?php  
        ...
        $str="select * from complainasingnbook where emp_id='$emp_id' AND status='U' ";
        $row=$con->query($str);
   ...
   <div class='col-md-6'>
        ...
        <div class='col-md-6'>
            <button class="col-md-12 btn btn-warning" id="assign"> Processed </button>
       </div> 
    </div>
 <script type="text/javascript" src="js/jquery-3.0.0.min.js"></script>
<script language="javascript">
    $('#assign').click(function(){
        ...
        var data12=values;
                // alert(data12);
                  $.ajax({
                   url:"updatingstatus.php",
                   method:"POST",
                   data:{data12:data12},
                   dataType:"text",
                   success:function(data){
                     alert(data);
                     window.location.reload('complain_service_handler.php');
                   }
                });
});
</script>
